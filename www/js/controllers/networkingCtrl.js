...
.controller('networkingCtrl', function($scope, $state,$window, session, ajax, cachedImage, $ionicPopup, messages, $ionicModal) {
	...
	var element = $window.document.getElementById('text_code');
	//element.focus();
